...
namespace TreeDocs.Auth
{
    ...
    internal static class AppResources
    {
        private static readonly ResourceManager _resourceManager 
            = new ResourceManager("TreeNotes.Auth.IdentityExtensions.Resources", typeof(Resources).Assembly);
        private static readonly ResourceManager _resourceManagerEN
            = new ResourceManager("Microsoft.Extensions.Identity.Core.Resources", typeof(Microsoft.AspNetCore.Identity.IdentityErrorDescriber).Assembly);
        ...
        private static string GetString(string name, params string[] formatterNames)
        {
            ...
            if(CultureInfo.CurrentCulture.Name.Contains("en"))
                value = _resourceManagerEN.GetString(name);
            else
